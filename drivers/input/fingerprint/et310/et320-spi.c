...
{
	return sprintf(buf,"sss%x %x %x %x\n", result[0],result[1],result1[0],result1[1]);
	//return 0;
}
...
static struct spi_driver fp_spi_driver = {
	...
	.remove = fp_remove,
#ifndef CONFIG_PM
	.suspend        = fp_spi_suspend,
	.resume         = fp_spi_resume,
#endif

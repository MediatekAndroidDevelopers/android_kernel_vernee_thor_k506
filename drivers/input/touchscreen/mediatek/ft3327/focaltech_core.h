...
#define TPD_BUTTON_WIDTH        				(70)  			// 100

#define TPD_KEY_COUNT           				3    				// 4
#define TPD_KEYS                					{ KEY_MENU, KEY_HOMEPAGE, KEY_BACK}
#define TPD_KEYS_DIM            					{{180,1338,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {360,1338,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}, {540,1338,TPD_BUTTON_WIDTH,TPD_BUTTON_HEIGH}}
...
#define FT_TP_SHOW_FW_STATUS    		// show FW version 
...
#define SYSFS_DEBUG
//#define TPD_AUTO_UPGRADE 		//auto update FW

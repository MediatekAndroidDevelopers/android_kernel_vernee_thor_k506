...
static const struct of_device_id ft5x0x_dt_match[] = {
	{.compatible = "mediatek,cap_touch_ft3327"},
	{},
};
...
#ifdef FT_TP_SHOW_FW_STATUS		 /*-------SHOW_FW_STATUS------------*/
u8 fw_version;   //save FW version
...
/*#ifdef CONFIG_FT_AUTO_UPGRADE_SUPPORT
	...
	TPD_DEBUG("deng, read_FW_version: %x \n",fw_version);
	...
	pr_err("tpd_probe ft3327 succeed\n");
